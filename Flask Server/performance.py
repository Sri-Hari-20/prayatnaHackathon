...
for i in ['herself','himself','myself','i','me','my']:
	stahpwords.remove(i)
...
if __name__ == "__main__":
	...
	pipeline = Pipeline([('bow', CountVectorizer(analyzer=text_pre_process)),  # strings to token integer counts
	...
	joblib.dump(clf, 'suicideClassifier_svm.pkl')
